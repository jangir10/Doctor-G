...
const MyProfile = () => {
  const [userData, setUserData] = useState({
    ...
    phone: '+91 1234567890',
    Address: {
      line1: "01, Vasant Vihar",
      line2: "Jodhpur, Rajasthan"
    },
    gender: 'Male',
    dob: '2004-01-01'
  });
    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-500'>
          ...
          {
            isEdit
              ? <input className='max-w-28 bg-gray-100' type='date' onChange={(e)=>userData(prev=>({...prev,dob:e.target.value}))} value={userData.dob} />
